...
|-------|------|-------------|
| `IO_GET_PROCESS_LIST` | `0x1724` | Enumerate processes |
| `IO_COPY_MEMORY` | `0x1725` | Read process memory |
| `IO_UNLOAD_DRIVER` | `0x1726` | Unload driver |
| `IO_WRITE_MEMORY` | `0x1727` | Write process memory |
| `IO_READ_KERNEL` | `0x1728` | Read kernel memory |
| `IO_DSE_SET_ADDR` | `0x1730` | Set g_CiOptions address(es) |
| `IO_DSE_DISABLE` | `0x1731` | Disable DSE (g_CiOptions = 0) |
| `IO_DSE_ENABLE` | `0x1732` | Restore DSE |
| `IO_DSE_QUERY` | `0x1733` | Query DSE state |
...
dse_client.c            New - DSE control tool
```
